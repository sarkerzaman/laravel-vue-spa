<template>
    <div class="row">
        ...
        <div class="col-md-4 pb-4">
            ...
            <div v-if="inBasketAlready" class="warning mt-4 text-muted">
                You have already added this item in the basket. If you want to change date, remove the item from your basket first
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    created(){
        this.loading = true;
        return axios.get(`/api/bookables/${this.$route.params.id}`).then(response => {
